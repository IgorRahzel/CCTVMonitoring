...
- [Funcionamento do Código](#funcionamento-do-codigo)
  - [Backend](#backend)
    - [Classes Auxiliares](#classes-auxiliares)
      ...
      - [area](#2-area)
      - [heatMap](#3-heatmap)
      - [spaghetti](#4-spaghetti)
      - [trajectoryGraph](#5-trajectorygraph)
      - [stats](#6-stats)
  ...
  - [Frontend](#frontend)
    - [Componentes da Interface](#componentes-da-interface)
      - [AreaStats](#1-areastats)
      - [CameraView](#2-cameraview)
      - [FlowDiagram](#3-flowdiagram)
      - [HeatMap](#4-heatmap)
      - [PeopleStats](#5-peoplestats)
      - [PersonDetails](#6-persondetails)
